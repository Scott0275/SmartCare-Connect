...
export default function DoctorPrescriptionView() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-4">Prescription #{prescription.id}</h1>
      ...
      <div className="bg-white rounded shadow p-4 mb-4">
        ...
        <div className="mb-2"><strong>Updated:</strong> {new Date(prescription.updatedAt?.toDate ? prescription.updatedAt.toDate() : prescription.updatedAt).toLocaleString()}</div>
      </div>
